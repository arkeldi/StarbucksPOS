...
const Menu = (props) => (
  ...
  <div>
    ...
    <div style={{ marginTop: '20px', marginBottom: '100px', padding: '30px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
            <Link to="/productemployee/1" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
            <Link to="/productemployee/2" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
            <Link to="/productemployee/3" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
            <Link to="/productemployee/4" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
            <Link to="/productemployee/5" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
            <Link to="/productemployee/6" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/7" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/8" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/9" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/10" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/11" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/12" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/13" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/14" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/15" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/16" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/17" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/18" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/19" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/20" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/21" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/22" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ marginTop: '50px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/23" style={{ textDecoration: 'none' }}>
    ...
    <div style={{ marginTop: '100px'}}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/24" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/25" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/26" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/27" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/28" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/29" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/30" style={{ textDecoration: 'none' }}>
          <img src={require('./server/product_30.png')} alt="Cafe Latte" style={{ width: '181px', marginTop:'15px' }} />
          <h3 style={{ textAlign: 'center', color: 'black', fontSize: '1.5em'}}>Iced Cafe Con Leche</h3>
          </Link>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/31" style={{ textDecoration: 'none' }}>
          <img src={require('./server/product_31.png')} alt="Cappuccino" style={{ width: '181px', marginTop:'15px'  }} />
          <h3 style={{ textAlign: 'center', color: 'black', fontSize: '1.5em'}}>Cold Brewed Iced Coffee</h3>
          </Link>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/32" style={{ textDecoration: 'none' }}>
          <img src={require('./server/product_32.png')} alt="Cappuccino" style={{ width: '181px', marginLeft:'45px'  }} />
    ...
    <div style={{ marginTop: '100px'}}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/33" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/34" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/35" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/36" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/37" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/38" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/39" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/40" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/41" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/42" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/43" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/44" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/45" style={{ textDecoration: 'none' }}>
    ...
    <div style={{ marginTop: '100px'}}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/46" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/47" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/48" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/49" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/50" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/51" style={{ textDecoration: 'none' }}>
    ...
    <div style={{ marginTop: '100px'}}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/52" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/53" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/54" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/55" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/56" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/57" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/58" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/59" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/60" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/61" style={{ textDecoration: 'none' }}>
    ...
    <div style={{ marginTop: '100px'}}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/62" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/63" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/64" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/65" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/66" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/67" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/68" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/69" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/70" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/71" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/72" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/73" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/74" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/75" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/76" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/77" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee78" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/79" style={{ textDecoration: 'none' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/80" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/81" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/82" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/83" style={{ textDecoration: 'none' }}>
          <img src={require('./server/product_83.png')} alt="Cafe Latte" style={{ width: '181px', marginLeft:'50px'  }} />
          <h3 style={{ textAlign: 'center', color: 'black', fontSize: '1.5em'}}>Belvita Blueberry Breakfast Biscuits</h3>
          </Link>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/84" style={{ textDecoration: 'none' }}>
    ...
    <div style={{ marginTop: '100px'}}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/85" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/86" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/87" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/88" style={{ textDecoration: 'none' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <Link to="/productemployee/89" style={{ textDecoration: 'none' }}>
