  ...
  <div>
    ...
    <div style={{ marginTop: '100px', marginBottom: '100px', padding: '30px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <a href="/products">
          <img src={require('./server/product_42.png')} alt="Cafe Latte" style={{ width: '181px' }} />
          <h3 style={{ textAlign: 'center' }}>Strawberries and Frappuccino</h3>
          </a>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <a href="/products">
          <img src={require('./server/product_43.png')} alt="Cappuccino" style={{ width: '181px' }} />
          <h3 style={{ textAlign: 'center' }}>Double Choclate Chip Frappuccino</h3>
          </a>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <a href="/products">
          <img src={require('./server/product_44.png')} alt="Cappuccino" style={{ width: '181px' }} />
          <h3 style={{ textAlign: 'center' }}>Syrup Creme Frappuccino</h3>
          </a>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 30px' }}>
        <a href="/products">
          <img src={require('./server/product_45.png')} alt="Cappuccino" style={{ width: '181px' }} />
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const h5Tags = document.getElementsByTagName("h2");
