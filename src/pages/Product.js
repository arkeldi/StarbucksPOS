...
const Product = () => {
  ...
  const handleClick = () => {
    ...
    navigate('/order', { state: { menuText: menuText, combinedValues: combinedValues ,productPrice: productPrice, buttonPressed: true}});
            ...
            background: 'blue'}} >
              <div style={{
                ...
                background: 'white'}}> 
                  ...
                  <a style={{ cursor: 'pointer', fontSize: '20px', marginBottom: '20px', fontFamily: 'SoDoSans,Helvetica Neue,Helvetica,Arial,sans-serif'}} onClick={handleClickCompany}>Our Company</a>
